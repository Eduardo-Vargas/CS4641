 ...
 * @version 1.0
 */
public class AbaloneTestRNLoop {
    private static Instance[] instances = initializeInstances();

    private static int inputLayer = 16, hiddenLayer = 10, outputLayer = 1, trainingIterations = 200;
...
//
        ...
        for(int loops=0; loops<2; loops++) {
            ...
            fileName = "Letters" + hiddenLayer + "HL" + trainingIterations + "E.txt";
