 ...
 * @version 1.0
 */
public class AbaloneTestRN1 {
	private static final int NUM_ATTRIBUTES = 16;
    private static Instance[] instances = initializeInstances();

    private static int inputLayer = NUM_ATTRIBUTES, hiddenLayer = 5, outputLayer = 26, trainingIterations = 100;
    ...
    public static void main(String[] args) {
       ...
       // oa[2] = new StandardGeneticAlgorithm(200, 20, 10, nnop[2]);
    ...
    private static Instance[] initializeInstances() {
        ...
        try {
            ...
            for(int i = 0; i < attributes.length; i++) {
                ...
                attributes[i][0] = new double[NUM_ATTRIBUTES]; // 11 attributes
